    ...
    <div className="h-[100dvh] w-screen">
      <div className="flex md:flex-row w-full h-full">
        <section className="flex flex-col px-8 sm:p-20 xl:w-[50%] md:w-4/5">
          <MobileWaves />
          <div className="2xl:px-32 md:px-20 max-w-4xl m-auto z-10 p-10 rounded-lg shadow-lg sm:shadow-none bg-white">
...
function LoginForm({ setUsername, setPassword, loading, failed }: any) {
